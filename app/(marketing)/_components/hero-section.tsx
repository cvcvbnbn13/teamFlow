...
import PrimsaLogo from "@/public/primsa.svg";
      ...
      <main className="overflow-hidden">
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  AI Solutions For Team Communication
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="mx-auto mt-12 grid max-w-2xl grid-cols-6 gap-8 transition-all duration-500 sm:gap-y-14">
              <div className="flex">
                <Image
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-7 object-contain dark:invert-0"
                  src={MotionLogo}
                  alt="Motion Logo"
                />
              </div>
